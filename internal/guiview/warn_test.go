...
const goldenWarningText = `Сейчас будет изменение на сервере
...
// совпадать с подписью кнопки отказа диалогов операций: текст советует
// "закройте изменение", и человек ищет на экране именно это слово.
