...
const (
	wantLayoutHintPin      = "Похоже, включена не английская раскладка: пин-код принимает только латинские буквы, цифры и знаки препинания."
	wantLayoutHintKey      = "Похоже, включена не английская раскладка: админский ключ состоит только из латинских букв, цифр и знаков препинания."
