...
// ОБЩЕМУ правилу — TestFloatingHintCoversNothingInteractive требует, чтобы
// всплывашка не накрывала НИ ОДНОГО органа управления формы, а не только тех
// двух, которых мы назначили «своими». Прежняя редакция спрашивала про поле и
// кнопку подтверждения и потому не заметила ни имени хранилища, ни поля
